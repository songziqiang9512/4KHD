...
final class FavoritesModuleStoreTests: XCTestCase {
    ...
    func testSourceDeterminationByHost() {
        ...
        XCTAssertEqual(FavoriteSource.source(for: Self.makeRecord(id: "a1", detailURL: "https://taiav.com/cn/movie/66846ff2f40c787c969d3c85")), .taiav)
        ...
        XCTAssertNil(FavoriteSource.source(for: Self.makeRecord(id: "a2", detailURL: "https://taiav.com.evil.example/cn/movie/66846ff2f40c787c969d3c85")))
