...
@MainActor
final class MrdsFilmstripView: NSView, NSCollectionViewDataSource, NSCollectionViewDelegate {
    ...
    private var slots: [MrdsImageSlot] = []
    ...
    func update(slots: [MrdsImageSlot], selectedIndex: Int, showsLoadingTile: Bool) {
    ...
    func collectionView(
        ...
        if indexPath.item >= slots.count {
            return collectionView.makeItem(withIdentifier: MrdsFilmstripLoadingItem.reuseID, for: indexPath)
        }
        let item = collectionView.makeItem(
            withIdentifier: MrdsFilmstripItemView.reuseID,
            for: indexPath
        ) as? MrdsFilmstripItemView ?? MrdsFilmstripItemView()
    ...
    private func setupView() {
        ...
        collectionView.register(MrdsFilmstripItemView.self, forItemWithIdentifier: MrdsFilmstripItemView.reuseID)
        collectionView.register(MrdsFilmstripLoadingItem.self, forItemWithIdentifier: MrdsFilmstripLoadingItem.reuseID)
    ...
    private func refreshVisibleSelection() {
        for indexPath in collectionView.indexPathsForVisibleItems() {
            guard let item = collectionView.item(at: indexPath) as? MrdsFilmstripItemView else { continue }
...
@MainActor
private final class MrdsFilmstripItemView: NSCollectionViewItem {
    static let reuseID = NSUserInterfaceItemIdentifier("MrdsFilmstripItemView")
    ...
    func configure(slot: MrdsImageSlot, isSelected: Bool) {
        thumbnailView.configureRequest = MrdsRequestFactory.configureImageRequest
...
@MainActor
private final class MrdsFilmstripLoadingItem: NSCollectionViewItem {
    static let reuseID = NSUserInterfaceItemIdentifier("MrdsFilmstripLoadingItem")
